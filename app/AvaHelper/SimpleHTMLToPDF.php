...
class SimpleHTMLToPDF
{
    ...
    /**
     * SimpleHTMLToPDF constructor.
     */
    public function __construct()
    {
        $this->baseUrl = "http://api.simplehtmltopdf.com/";
        $this->defaultOrientation = "Portrait";
        $this->defaultMargins = array(10,10,10,10);
        $this->userAgent = "SimpleHTMLToPDF PHP Wrapper";
        $this->defaultName = date("YmdHis").'.pdf';
    }
