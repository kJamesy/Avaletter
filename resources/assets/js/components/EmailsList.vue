<template>
    <div class="emails-list" v-if="successfulFetch" v-cloak>
        ...
        <table class="table">
            ...
            <tbody>
                <tr v-for="email in orderedEmails">
                    ...
                    <td><router-link v-bind:to="{ name: 'emails.index', params: { id: email.id } }" class="btn btn-default btn-xs"><i class="fa fa-pencil-square-o"></i></router-link></td>
                    <td></td>
            ...
            fetchEmails(orderAttr, orderToggle) {
                ...
                vm.$http.get(vm.resourceUrl, {params : params}).then(function(response) {
                    ...
                    if ( emails && emails.data && emails.data.length ) {
                        ...
                        var message = vm.searching ? 'Your search returned no results. Please try again with different keywords' : 'You don\'t have any emails yet. Please add some';
